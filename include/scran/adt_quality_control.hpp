 ...
 * This improves resolution at low values, symmetrizes long right tails, and ensures that the defined threshold is not negative.
...
struct FiltersOptions {
    ...
    /**
     * Number of MADs above the median, to define the threshold for outliers in the subset totals.
     * This should be non-negative.
     */
